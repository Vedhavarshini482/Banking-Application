...
public class AccountManagementView implements AccountManagementViewCallBack {

	private AccountManagementControllerCallBack controller;
	...
	public void savingAccount() {
		...
		controller.generateAccountNumber(name, age, mobileNumber, address);
	}
	...
	public void userLogin() {
		...
		controller.validLogin(accountNumber, mPin);
	}
	...
	private void setPinNumber(String[] user) {
		...
		controller.setPinNumber(accountNumber, pinNumber);
		mPin(accountNumber);
	}
	...
	public void mPin(String accountNumber) {
		...
		controller.setMPin(accountNumber, mPin);
